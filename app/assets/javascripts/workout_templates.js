...
$(document).ready(function(){
  ...
  $(".timer").circletimer({
    ...
    onUpdate: (function(elapsed) {
      ...
      var myArray = ["YOU CAN DO IT!", "COME'ON! ALMOST THERE!", "GREAT JOB, KEEP GOING!", "NO PAIN NO GAIN!", "WORKING OUT IS FUN!", "KEEP SMILING, KEEP WORKING", "GIVE YOUR BEST EFFORT!", "POWER THROUGH THE POWER MINUTE!", "YOU'RE THE BEST AROUND!","NO ONE'S EVER GONNA TAKE YOU DOWN","SHOW OFF YOUR POWER","BREATHEEEE","GET FIT OR DIE TRYING","LOVE YOUR LIFE, PUSH YOUR BODY","YOU INSPIRE ME","BUFF IN 60 SECONDS","DAMN YOU LOOK GOOD! HAVE YOU BEEN WORKING OUT?", "RIPPED AND READY, DON'T STOP THE SHREDDY!","HARDER BETTER FASTER STRONGER","YOU KNOW YOU WANT IT!"]
